...
function SpotifyIcon() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4 shrink-0 text-[#1DB954]">
...
export default function SpotifyButton() {
  return (
    <a
      ...
      className="glass glass-edge flex min-h-[40px] sm:min-h-[44px] items-center justify-center gap-1.5 sm:gap-2 rounded-full px-3.5 sm:px-4 text-[11.5px] sm:text-[12.5px] font-medium text-cream/90 transition-all hover:text-white hover:bg-white/10 hover:border-[#1DB954]/50 active:scale-95 touch-manipulation select-none shadow-md"
    >
      <SpotifyIcon />
